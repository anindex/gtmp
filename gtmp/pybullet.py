'''Adapted from https://github.com/KavrakiLab/vamp/blob/main/src/vamp/pybullet_interface.py'''
...
class PyBulletSimulator:
    ...
    def update_object_position(
            self, multibody_id: int, position: np.ndarray, rot_xywz: np.ndarray = [0, 0, 0, 1]
        ):
